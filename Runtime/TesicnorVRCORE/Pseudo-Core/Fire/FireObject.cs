    ...
    public sealed class FireObject : MonoBehaviour, FireUtils
    {
        ...
        */
        ...
        public void AdaptSmoke()
        {
            ...
            smoke_System.transform.localPosition = fire_MR.bounds.center + new Vector3(0,fire_MR.bounds.size.y/2,0);
        ...
        public void OnDrawGizmos()
        {
            ...
            Gizmos.DrawWireCube(fire_MR.bounds.center, new Vector3(size.x * scale.x, size.y*scale.y, size.z * scale.z));
        }
