    ...
    public sealed class FireObject : MonoBehaviour, FireUtils
    {
        ...
        */
        ...
        public void OnDrawGizmos()
        {
            ...
            Matrix4x4 rotationMatrix = Matrix4x4.TRS(fire_MR.bounds.center, transform.rotation, transform.InverseTransformDirection(new Vector3(size.x * scale.x, size.y * scale.y, size.z * scale.z)));
