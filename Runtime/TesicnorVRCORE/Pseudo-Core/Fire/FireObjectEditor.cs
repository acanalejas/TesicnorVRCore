...
public class FireObjectEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        #region Zona de par�metros
        GUILayout.BeginVertical(EditorStyles.helpBox);

        #region Ajustes del fuego
        if (fireSettings)
        {
            GUILayout.Label("El prefab de las part�culas de fuego");
            ...
            GUILayout.Label("El offset en el collider para la propagaci�n del fuego", EditorStyles.boldLabel);
            manager.PropOffset = EditorGUILayout.Vector3Field("Propagation Offset", manager.PropOffset);

            GUILayout.Space(10);

            GUILayout.Label("La emissi�n de referencia", EditorStyles.boldLabel);
            manager.MaxEmission = EditorGUILayout.FloatField(manager.MaxEmission, EditorStyles.miniTextField);

            GUILayout.Space(10);

            GUILayout.Label("El tama�o de referencia", EditorStyles.boldLabel);
