...
public class MultiplayerCreation : MonoBehaviour
{
    ...
    {
        GameObject playerControllers = new GameObject("PlayerControllers", typeof(CameraOffset), typeof(ReplicatedObject));
        ...
        // ================================== SETEANDO VALORES PARA MULTIPLAYER =====================================

        ReplicatedObject player_ro = playerControllers.GetComponent<ReplicatedObject>();
        if (player_ro)
        {
            player_ro.insidePlayer = true;
            player_ro.this_transform = playerControllers.transform;
        }
    ...
    [MenuItem("Tesicnor/Multiplayer/Multiplayer Player (Controllers with hand mesh)")]
    public static void CreateMultiplayerPlayer_Controllers_HandMesh()
    {
        GameObject playerControllers = new GameObject("PlayerControllers", typeof(CameraOffset), typeof(ReplicatedObject));
        if (Selection.gameObjects.Length > 0) playerControllers.transform.parent = Selection.gameObjects[0].transform;
        playerControllers.transform.localPosition = Vector3.zero;
    ...
    public static void CreateMultiplayerPlayer_Hands()
    {
        ...
        //SETEANDO VALORES PARA EL MULTIPLAYER

        ReplicatedObject player_ro = playerHands.GetComponent<ReplicatedObject>();
        if (player_ro)
        {
            player_ro.insidePlayer = true;
            player_ro.this_transform = playerHands.transform;
        }
    ...
    [MenuItem("Tesicnor/Multiplayer/Multiplayer Manager Client")]
    public static void CreateMultiplayerManager_Client()
    {
        GameObject manager = new GameObject("Multiplayer Manager", typeof(MultiplayerManager), typeof(UniqueIDManager), typeof(MultiplayerClient));
        if (Selection.gameObjects.Length > 0) manager.transform.parent = Selection.gameObjects[0].transform;
    ...
    [MenuItem("Tesicnor/Multiplayer/Multiplayer Manager Host")]
    public static void CreateMultiplayerManager_Host()
    {
        GameObject manager = new GameObject("Multiplayer Manager", typeof(MultiplayerManager), typeof(UniqueIDManager), typeof(MultiplayerHost));
        if (Selection.gameObjects.Length > 0) manager.transform.parent = Selection.gameObjects[0].transform;
    ...
    [MenuItem("Tesicnor/Multiplayer/Multiplayer Manager Host & Client")]
    public static void CreateMultiplayerManager_Both()
    {
        GameObject manager = new GameObject("Multiplayer Manager", typeof(MultiplayerManager), typeof(UniqueIDManager), typeof(MultiplayerClient), typeof(MultiplayerHost));
        if (Selection.gameObjects.Length > 0) manager.transform.parent = Selection.gameObjects[0].transform;
