...
public class PlayerManager : MonoBehaviour
{
    ...
    /// <summary>
    /// El canvas que ense�a el mensaje de las manos
    /// </summary>
    [Header("El canvas que ense�a el mensaje de las manos")]
    [SerializeField] private GameObject useHandsCanvas;

    /// <summary>
    /// El canvas que ense�a el mensaje de los mandos
    /// </summary>
    [Header("El canvas que ense�a el mensaje de los mandos")]
    ...
    /// <summary>
    /// El anchor de la c�mara en el player de las manos
    /// </summary>
    [Header("El anchor de la c�mara en el player de las manos")]
    [SerializeField] private Transform playerHands_Camera;

    /// <summary>
    /// El anchor de la c�mara en el player que usa los mandos
    /// </summary>
    [Header("El anchor de la c�mara en el player que usa los mandos")]
    ...
    /// <summary>
    /// Est�n los mandos activos y en uso?
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// Funcion que ense�a y posiciona / desactiva el mensaje para soltar los mandos
    /// </summary>
